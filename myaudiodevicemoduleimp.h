#ifndef MYAUDIODEVICEMODULEIMP_H
#define MYAUDIODEVICEMODULEIMP_H
...
class MyAudioDeviceModuleImpl : public AudioDeviceModule {
 public:
  enum PlatformType {
  ...
  MyAudioDeviceModuleImpl(const AudioLayer audioLayer);
  ~MyAudioDeviceModuleImpl() override;
...
#endif // MYAUDIODEVICEMODULEIMP_H
